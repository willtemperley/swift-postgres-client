...
struct ISO8601Test {
    ...
    func parseTimestampWithTimeZone() {
        ...
        func checkInvalid(_ string: String) {
            #expect(ISO8601.parseTimestampWithTimeZone(string) == nil)
        }
    ...
    func ParseTimestamp() {
        ...
        func checkInvalid(_ string: String) {
            #expect(ISO8601.parseTimestamp(string) == nil)
        }
    ...
    func parseDate() {
        ...
        func checkInvalid(_ string: String) {
            #expect(ISO8601.parseDate(string) == nil)
        }
    ...
    func parseTime() {
        ...
        func checkInvalid(_ string: String) {
            #expect(ISO8601.parseTime(string) == nil)
        }
    ...
    func timeZoneHasFixedOffset() {
        ...
        #expect(ISO8601.timeZoneHasFixedOffsetFromUTC(tzUTC))
        #expect(ISO8601.timeZoneHasFixedOffsetFromUTC(tzPlus0100))
        #expect(ISO8601.timeZoneHasFixedOffsetFromUTC(tzMinus0100))
        #expect(ISO8601.timeZoneHasFixedOffsetFromUTC(tzLosAngeles) == false)
    }
