...
struct PostgresTimestampTest  {
    ...
    func test() {
        ...
        #expect(PostgresTimestamp(
            year: 2019, month: 0, day: 1,
            hour: 1, minute: 1, second: 1, nanosecond: 1) == nil)
        
        // Invalid component values should fail.
        #expect(PostgresTimestamp(
            year: 2019, month: 2, day: 29,
            hour: 1, minute: 1, second: 1) == nil)
        ...
        #expect(PostgresTimestamp("foo") == nil)
        
        // Invalid string representation should fail.
        #expect(PostgresTimestamp("2019-00-01 01:01:01.000") == nil)
    ...
    func checkTimestamp(
        ...
        _ expectedDescription: String) {
            ...
            func checkTimestamp(_ ts: PostgresTimestamp) {
                ...
                assertApproximatelyEqual(tsUtcDate, expectedUtcDate)
                assertApproximatelyEqual(tsPacificDate, expectedPacificDate)
