...
struct PostgresTimeTest {
    ...
    @Test func test() {
        ...
        #expect(PostgresTime(hour: 1, minute: 61, second: 1, nanosecond: 1) == nil)
        ...
        #expect(PostgresTime("foo") == nil)

        // Invalid string representation should fail.
        #expect(PostgresTime("01:61:01.000") == nil)
    ...
    func checkTime(
        ...
        func checkTime(_ t: PostgresTime) {
            ...
            assertApproximatelyEqual(tUtcDate, expectedUtcDate)
            assertApproximatelyEqual(tPacificDate, expectedPacificDate)
