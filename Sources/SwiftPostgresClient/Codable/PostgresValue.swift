...
///
public struct PostgresValue: PostgresValueConvertible, Equatable, CustomStringConvertible, Sendable {
...
public extension PostgresValue {
    ...
    func optionalDecimal() throws -> Decimal? {
        ...
        guard let v = Decimal(string: rawValue, locale: ISO8601.enUsPosixLocale) else {
