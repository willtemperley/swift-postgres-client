...
struct ISO8601 {
    ...
    static func parseTimestampWithTimeZone(_ value: String) -> Date? {
        do {
            var parser = ISO8601(value)
    ...
    static func parseTimestamp(_ value: String) -> DateComponents? {
        do {
            var parser = ISO8601(value)
            try parser.optionalWhitespace()
            try parser.date()
    ...
    /// - Parameter value: the string
    /// - Returns: the `DateComponents`, or `nil` if the string is invalid
    static func parseDate(_ value: String) -> DateComponents? {
        do {
            var parser = ISO8601(value)
            try parser.optionalWhitespace()
            try parser.date()
    ...
    /// - Parameter value: the string
    /// - Returns: the `DateComponents`, or `nil` if the string is invalid
    static func parseTime(_ value: String) -> DateComponents? {
        do {
            var parser = ISO8601(value)
            try parser.optionalWhitespace()
            try parser.time()
    ...
    /// - Parameter value: the string
    /// - Returns: the `DateComponents`, or `nil` if the string is invalid
    static func parseTimeWithTimeZone(_ value: String) -> DateComponents? {
        do {
            var parser = ISO8601(value)
            try parser.optionalWhitespace()
            try parser.time()
    ...
    /// - Returns: the string
    static func formatTimestampWithTimeZone(date: Date) -> String {
    ...
    /// - Returns: the string
    static func formatTimestamp(validatedDateComponents: DateComponents) -> String {
    ...
    /// - Parameter validatedDateComponents: the `DateComponents`; assumed to be valid
    /// - Returns: the string
    static func formatDate(validatedDateComponents: DateComponents) -> String {
    ...
    /// - Parameter validatedDateComponents: the `DateComponents`; assumed to be valid
    /// - Returns: the string
    static func formatTime(validatedDateComponents: DateComponents) -> String {
        var dc = validatedDateComponents
        dc.year = 2000
        dc.month = 1
        dc.day = 1
    ...
    /// - Parameter validatedDateComponents: the `DateComponents`; assumed to be valid
    /// - Returns: the string
    static func formatTimeWithTimeZone(validatedDateComponents: DateComponents) -> String {
        var dc = validatedDateComponents
        dc.year = 2000
        dc.month = 1
        dc.day = 1
    ...
    static func validateDateComponents(
    ...
    ///   - timeZone: the time zone to use; see above
    /// - Returns: the `Date`
    static func unvalidatedDate(from dateComponents: DateComponents,
    ...
    static func dateComponents(from date: Date, in timeZone: TimeZone) -> DateComponents {
    ...
    static let enUsPosixUtcCalendar = calendarFor(timeZone: utcTimeZone)
    ...
    static func timeZoneHasFixedOffsetFromUTC(_ timeZone: TimeZone) -> Bool {
    ...
    private mutating func date() throws {
    ...
    private mutating func time() throws {
    ...
    private mutating func timeZone() throws {
    ...
    private mutating func optionalWhitespace() throws {
    ...
    /// Consumes a dash.
    private mutating func dash() throws {
        if try next() != "-" {
            throw ParseError()
        }
    }
    ...
    private mutating func digits() throws -> Int {
    ...
    private mutating func fractionalDigits(denominator: Int) throws -> Int {
...
//    private static var calendars = [TimeZone : Calendar]()
    ...
    private static func calendarFor(timeZone: TimeZone) -> Calendar {
        var calendars: [TimeZone : Calendar] = [:]
...
//    private static var timeWithTimeZoneFormatters = [TimeZone : DateFormatter]()
    ...
    private static func timeWithTimeZoneFormatterFor(timeZone: TimeZone) -> DateFormatter {
        ...
        var timeWithTimeZoneFormatters: [TimeZone : DateFormatter] = [:]
