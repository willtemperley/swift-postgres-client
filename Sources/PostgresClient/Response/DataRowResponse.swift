...
struct DataRowResponse: Response {
    let responseType: Character = "D"
    let columns: [PostgresValue]

    init(responseBody: ResponseBody) throws {
        precondition(responseBody.responseType == "D")
    ...
    var description: String {
        "DataRowResponse(columns: \(columns))"
    }
}
